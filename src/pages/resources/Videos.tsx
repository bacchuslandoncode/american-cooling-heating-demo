  ...
  return (
    <div>
      ...
      <div className="container-page grid grid-cols-1 gap-6 py-14 sm:grid-cols-2 md:py-20">
        {videoLibrary.map((v) => (
          <div key={v.brand} className="flex items-center gap-4 rounded-[3px] border border-border bg-card p-6">
            <PlayCircle size={28} weight="light" className="text-brand" />
            <div>
              <p className="font-display text-base font-medium text-ink">{v.brand}</p>
