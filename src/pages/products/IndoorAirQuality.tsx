...
export function IndoorAirQuality() {
  ...
  return (
    <div>
      ...
      <PageHero kicker="Indoor Air Quality" tone="cooling" title={d.headline} subhead={d.summary} />
      <section className="py-14 md:py-20">
        <div className="container-page grid grid-cols-1 gap-px overflow-hidden rounded-[3px] border border-border bg-border sm:grid-cols-2">
          {d.products.map((p, i) => (
            <div key={p.name} className={cn("bg-card p-6", isOdd && i === d.products.length - 1 && "sm:col-span-2")}>
